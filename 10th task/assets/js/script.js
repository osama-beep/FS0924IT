...
function filmVecchio() {
  ...
  console.log("Il film più vecchio è:", filmPiuVecchio.Title, "dell'anno", filmPiuVecchio.Year);
  ...
  console.log("Il film con l'imdbID", cercaFilm("tt0848228").imdbID, "è:", cercaFilm("tt0848228").Title);
  ...
  console.log("L'indice del primo film uscito nell'anno", trovaIndicePrimoFilm(2005), "è:", movies[trovaIndicePrimoFilm(2005)].Title);
